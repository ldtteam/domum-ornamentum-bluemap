...
{
    public static final Key RENDERER_TYPE_KEY = new Key(Constants.MOD_ID, Constants.BlockEntityTypes.MATERIALLY_RETEXTURABLE.getPath());
    ...
    {
        return blockState.getNamespace().equals(Constants.MOD_ID);
    }
