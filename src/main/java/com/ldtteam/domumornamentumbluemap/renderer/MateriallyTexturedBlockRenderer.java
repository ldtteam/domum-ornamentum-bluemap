    ...
    private ResourcePath<Texture> getDomumMappedTexture(final ResourcePath<Texture> original, final Direction faceDir)
    {
        if (original != null)
        {
            ...
            if (blockEntity instanceof MateriallyTexturedBlockEntity materiallyTexturedBlockEntity)
            {
                ...
                {
                    final Optional<BlockState> blockState = Optional.ofNullable(resourcePack.getBlockStates().get(new ResourcePath<>(replacementBlock)));
                    ...
                    {
                        final Model mappedBlockModel = resourcePack.getModels().get(variant.get().getModel());
